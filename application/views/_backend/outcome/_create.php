            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <?php echo form_open_multipart("admin/outcome/create") ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Jumlah" name="outcome_count" required="required">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Harga Satuan <span style="color:red">*</span></b></label>
                                        <input type="number" class="form-control" placeholder="Harga Satuan" name="outcome_amount" required="required">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Total Harga <span style="color:red">*</span></b></label>
                                        <input type="number" class="form-control" placeholder="Total Harga" name="outcome_price" required="required">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Tanggal <span style="color:red">*</span></b></label>
                                        <input type="date" class="form-control" placeholder="Tanggal" name="outcome_date" required="required" value="<?php echo date('Y-m-d'); ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Deskripsi</b></label>
                                        <textarea cols="80" id="editor" name="outcome_desc" rows="10" style="resize:none;max-width:700px;"></textarea>
                                    </div>
