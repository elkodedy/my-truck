<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box">
            <?php echo form_open_multipart("admin/outcome") ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group" id="outcome_name" style="display: <?php if ($outcome[0]->outcome_category_id != 1) echo 'none'; ?>;">
                            ...
                            <input readonly type="hidden" class="form-control" name="outcome_id" required="required" value="<?php echo $outcome[0]->outcome_id; ?>">
                            <input readonly type="text" class="form-control" placeholder="Pengeluaran" name="outcome_name" value="<?php echo $outcome[0]->outcome_name; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><b style="color: black">Jumlah <span style="color:red">*</span></b></label>
                            <input readonly type="text" class="form-control" placeholder="Jumlah" name="outcome_count" required="required" value="<?php echo $outcome[0]->outcome_count; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><b style="color: black">Harga Satuan <span style="color:red">*</span></b></label>
                            <input readonly type="number" class="form-control" placeholder="Harga Satuan" name="outcome_amount" required="required" value="<?php echo $outcome[0]->outcome_amount; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><b style="color: black">Total Harga <span style="color:red">*</span></b></label>
                            <input readonly type="number" class="form-control" placeholder="Total Harga" name="outcome_price" required="required" value="<?php echo $outcome[0]->outcome_price; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><b style="color: black">Tanggal <span style="color:red">*</span></b></label>
                            <input readonly type="date" class="form-control" placeholder="Tanggal" name="outcome_date" required="required" value="<?php echo $outcome[0]->outcome_date; ?>">
                        </div>
