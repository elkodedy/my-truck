                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <div class="box-tools pull-left">
                                <div class="form-inline">
                                    ...
                                    <div class="input-group margin">
                                        <?php echo form_open("admin/outcome/search") ?>
                            ...
                            <div class="box-tools pull-right">
                                <div style="padding-top:10px">
                                    ...
                                    <a href="<?php echo site_url('admin/outcome') ?>" class="btn btn-success btn-flat" title="Refresh halaman">refresh</a>
                                    <a href="<?php echo site_url('admin/outcome/create_page') ?>" class="btn btn-primary btn-flat" title="Tambah data"> tambah</a>
                                </div>
                        ...
                        <div class="box-footer">
                            ...
                            <!-- COUNT DATA -->
                            <?php if ($outcome) { ?>
                                <div class="float-left">Tampil <?php echo ($nox + $numbers) . " - " . (count($outcome) + $numbers) . " dari " . $total_data; ?> Data</div>
                            <?php } else { ?>
