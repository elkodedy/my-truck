            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <?php echo form_open_multipart("admin/income/update") ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Jumlah" name="income_count" required="required" value="<?php echo $income[0]->income_count; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Harga Satuan <span style="color:red">*</span></b></label>
                                        <input type="text" class="form-control" placeholder="Harga Satuan" name="income_amount" required="required" value="<?php echo $income[0]->income_amount; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Total Harga <span style="color:red">*</span></b></label>
                                        <input type="text" class="form-control" placeholder="Total Harga" name="income_price" required="required" value="<?php echo $income[0]->income_price; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Tanggal <span style="color:red">*</span></b></label>
                                        <input type="date" class="form-control" placeholder="Tanggal" name="income_date" required="required" value="<?php echo $income[0]->income_date; ?>">
                                    </div>
