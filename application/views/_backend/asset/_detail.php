                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="asset_id" required="required" value="<?php echo $asset[0]->asset_id; ?>" readonly>
                                        <input type="text" class="form-control" placeholder="Nama Asset" name="asset_name" required="required" value="<?php echo $asset[0]->asset_name; ?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Jumlah <span style="color:red">*</span></b></label>
                                        <input type="text" class="form-control" placeholder="Jumlah" name="asset_count" required="required" value="<?php echo $asset[0]->asset_count; ?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Harga Satuan <span style="color:red">*</span></b></label>
                                        <input type="text" class="form-control" placeholder="Harga Satuan" name="asset_amount" required="required" value="<?php echo $asset[0]->asset_amount; ?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Total Harga <span style="color:red">*</span></b></label>
                                        <input type="text" class="form-control" placeholder="Total Harga" name="asset_price" required="required" value="<?php echo $asset[0]->asset_price; ?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Deskripsi</b></label>
                                        <textarea class="form-control" name="asset_desc" rows="10" readonly><?php echo $asset[0]->asset_desc; ?></textarea>
                                    </div>
