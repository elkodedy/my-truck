            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <?php echo form_open_multipart("admin/truck/update") ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nama Truk" name="truck_name" required="required" value="<?php echo $truck[0]->truck_name; ?>">
                                        <input type="hidden" class="form-control" name="truck_image_old" required="required" value="<?php echo $truck[0]->truck_image; ?>">
                                        <input type="hidden" class="form-control" name="truck_id" required="required" value="<?php echo $truck[0]->truck_id; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Merek Truk" name="truck_brand" required="required" value="<?php echo $truck[0]->truck_brand; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Nomor Plat <span style="color:red">*</span></b></label>
                                        <input type="text" class="form-control" placeholder="Nomor Plat" name="truck_plate" required="required" value="<?php echo $truck[0]->truck_plate; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Tahun Keluar <span style="color:red">*</span></b></label>
                                        <input type="number" class="form-control" placeholder="Tahun Keluar" name="truck_year" required="required" value="<?php echo $truck[0]->truck_year; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Warna Body <span style="color:red">*</span></b></label>
                                        <input type="text" class="form-control" placeholder="Warna Body" name="truck_color" required="required" value="<?php echo $truck[0]->truck_color; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" placeholder="Gambar" name="truck_image" accept=".png, .jpeg, .jpg">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Deskripsi</b></label>
                                        <textarea cols="80" id="editor" name="truck_desc" rows="10" style="resize:none;max-width:700px;"><?php echo $truck[0]->truck_desc; ?></textarea>
                                    </div>
