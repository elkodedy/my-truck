                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <div class="box-tools pull-left">
                                <div class="form-inline">
                                    ...
                                    <div class="input-group margin">
                                        <?php echo form_open("admin/truck/search") ?>
                            ...
                            <div class="box-tools pull-right">
                                <div style="padding-top:10px">
                                    ...
                                    <a href="<?php echo site_url('admin/truck') ?>" class="btn btn-success btn-flat" title="Refresh halaman">refresh</a>
                                    <a href="<?php echo site_url('admin/truck/create_page') ?>" class="btn btn-primary btn-flat" title="Tambah data"> tambah</a>
                                </div>
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                        ...
                                        <!-- Modal Delete-->
                                        <div class="modal fade" id="modalDelete<?php echo $key->truck_id; ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <?php echo form_open("admin/truck/delete") ?>
                                                    <div class="modal-body">
                                                        Apakah anda yakin akan menghapus data berita ini ?
                                                        <?php echo csrf(); ?>
                                                        <input type="hidden" class="form-control" name="truck_id" required="required" value="<?php echo $key->truck_id; ?>">
                                                    </div>
                        ...
                        <div class="box-footer">
                            ...
                            <!-- COUNT DATA -->
                            <?php if ($truck) { ?>
                                <div class="float-left">Tampil <?php echo ($nox + $numbers) . " - " . (count($truck) + $numbers) . " dari " . $total_data; ?> Data</div>
                            <?php } else { ?>
