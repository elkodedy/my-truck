                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="<?php echo site_url('admin/income') ?>"><i class="fa fa-circle-o"></i> Daftar Pemasukkan</a></li>
                                    <li><a href="<?php echo site_url('admin/income_category') ?>"><i class="fa fa-circle-o"></i> Jenis Pemasukkan</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#"> <i class="fa fa-money"></i> <span>Pengeluaran</span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul class="treeview-menu">
                                    <li><a href="<?php echo site_url('admin/outcome') ?>"><i class="fa fa-circle-o"></i> Daftar Pengeluaran</a></li>
                                    <li><a href="<?php echo site_url('admin/outcome_category') ?>"><i class="fa fa-circle-o"></i> Jenis Pengeluaran</a></li>
                                </ul>
                            </li>
